...
const FEATURES = [
  ...
  ['Everything else', [
    ['Keyboard shortcuts', '1–9/0 pick bands, ← → step, ↑ ↓ switch boost/cut in Mixed, Space toggles EQ/Flat, Enter checks or advances.', null],
  ...
  return (
    <div className="td-page">
      ...
      <Section id="modes">
        ...
        <div className="td-table-wrap">
          <table className="td-table">
            ...
            <tbody>
              ...
              <tr><td>Shelves</td><td>low/high shelf, ±gain</td><td>corner frequency</td><td>60 Hz – 10 kHz</td><td>2–8 corners</td></tr>
        ...
        <p className="td-p">
          In Shelves, corners below 1 kHz are low shelves and corners above are high shelves, and the
          direction (boost or cut) is random. In Pass Filters the Gain slider has no effect.
        </p>
      </Section>
